	...
	var domoPanel = function(){
		// Remove PerfectScrollbar initialization since it's causing issues
		// Other panel-related code can stay...
	};
...
jQuery(document).ready(function() {
	...
	// Now domoPanel is in global scope and can be called directly
	if (typeof domoPanel === 'function') {
		try {
			domoPanel();
		} catch (error) {
			console.warn("Panel initialization skipped:", error.message);
		}
	}
});
/* Document.ready END */
